    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-layout-text-window-reverse"></i><span>Pengelolaan Pajak</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="<?php echo BASE_URL; ?>/sikeu/hutang/hutang_piutang.php">
                <i class="bi bi-journal-text"></i><span>Hutang Piutang</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
